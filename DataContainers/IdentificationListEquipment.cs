...
public sealed class IdentificationListEquipment(IDalamudPluginInterface pi, Logger log, IDataManager gameData, ItemsByType items)
    : KeyList<PseudoEquipItem>(pi, log, "EquipmentIdentification", gameData.GetSafeLanguage(), Version.IdentificationListEquipment, () => CreateEquipmentList(items), ToKey, ValidKey,
