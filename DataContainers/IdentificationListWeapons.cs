...
public sealed class IdentificationListWeapons(IDalamudPluginInterface pi, Logger log, IDataManager gameData, ItemsByType data)
    : KeyList<PseudoEquipItem>(pi, log, "WeaponIdentification", gameData.GetSafeLanguage(), Version.IdentificationListWeapons, () => CreateWeaponList(data), ToKey, ValidKey, ValueKeySelector,
        data.Awaiter)
{
